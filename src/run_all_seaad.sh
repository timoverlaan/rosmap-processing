...
# pixi run python -m rosmap_processing.utils.validation \
#     data/seaAD/PFC/RNAseq/SEAAD_A9_RNAseq_final-nuclei.2024-02-13.h5ad

pixi run python -m rosmap_processing.core.column_mapping \
    data/seaAD/PFC/RNAseq/SEAAD_A9_RNAseq_final-nuclei.2024-02-13.h5ad --inplace --data-type SeaAD

pixi run python -m rosmap_processing.pipelines.scanpy \
    data/seaAD/PFC/RNAseq/SEAAD_A9_RNAseq_final-nuclei.2024-02-13.h5ad \
